@echo off
REM KROMA Deployment Script for Windows
REM Este script automatiza el deployment completo
...
REM Step 1: Deploy Sanity Studio
...
REM Step 3: Instructions for Vercel
